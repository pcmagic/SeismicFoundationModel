...
def mae_vit_tiny_patch16_Ji(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=8, embed_dim=4, depth=1, num_heads=2,
...
def mae_vit_large_patch16_dec256d4b(**kwargs):
    model = MaskedAutoencoderViT(
...
mae_vit_tiny_patch16 = mae_vit_tiny_patch16_Ji  # decoder: ? dim, ? blocks
...
mae_vit_large_patch16D4d256 = mae_vit_large_patch16_dec256d4b  # decoder: 512 dim, 8 blocks
mae_vit_base_patch16D4d256 = mae_vit_base_patch16_dec256d4b